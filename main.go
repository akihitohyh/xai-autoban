...
<body>
    ...
    <section class="toolbar">
      <div class="toolbar-row">
        ...
        <div class="segments" id="filters">
          <button data-status="all" class="active">全部</button><button data-status="402">402</button><button data-status="403">403</button><button data-status="429">429</button>
        </div>
  ...
  <script>
    ...
    function counts(){const out={402:0,403:0,429:0};for(const ban of state.bans)if(out[ban.status_code]!==undefined)out[ban.status_code]++;return out}
